...
<tr><td class="meta">Name</td><td><input type='text' name='s_Name' value='<?php print $item['Name'] ?>'></td></tr>
<tr><td class="meta">Alias</td><td><input type='text' name='s_Alias' value='<?php print $item['Alias'] ?>'></td></tr>
