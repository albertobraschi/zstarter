<div class="header"><h3>Modules</h3></div>
...
<tr>
<th></th>
<?php foreach ($this->modules[0] as $key => $value): ?>
<th><?php echo $key; ?></th>
<?php endforeach; ?>
<th>&nbsp;</th>
<th>&nbsp;</th>
...
<td><a href="<?php echo $this->editurl.$item['ID']; ?>/"><img border="0" src="http://taryk/admin/public/design/img/b_edit.png" alt="DELETE"/></a></td>
<td><a href="<?php echo $this->deleteurl.$item['ID']; ?>/"><img border="0" src="http://taryk/admin/public/design/img/b_drop.png" alt="DELETE"/></a></td>
</tr>
<?php endforeach; ?>
</tbody>
</table><br/><br/>
...
<a href="<?php echo $this->addurl; ?>">Add new</a><br/>
